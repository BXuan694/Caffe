...
ifeq ($(USE_OPENCV), 1)
	LIBRARIES += opencv_videoio opencv_highgui opencv_imgproc opencv_core
...
.PHONY: all lib test clean docs linecount lint lintclean tools examples $(DIST_ALIASES) \
	py py$(PROJECT) proto runtest superclean supercleanlist supercleanfiles warn everything
...
linecount:
	cloc --read-lang-def=$(PROJECT).cloc \
		src/$(PROJECT) include/$(PROJECT) tools examples python
